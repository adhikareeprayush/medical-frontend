    ...
    <>
      ...
      <div className="my-6 flex w-full flex-col items-center">
        <div className="">
          ...
          <div className="mx-auto my-5 flex w-full max-w-[300px] items-center rounded-full border border-gray-300 bg-white px-1  shadow-sm transition-all focus-within:ring-2 focus-within:ring-blue-500">
            <input
              type="search"
              placeholder="Search"
